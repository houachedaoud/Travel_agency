     ...
     <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        <form class="signup-form" action="../../TripsCRUD" method="post">
            ...
            <div class="form-body">
              ...
              <!-- Firstname and Lastname -->
                <div class="formitems">
                  ...
                  <input type="date" id="firstname" class="form-input" placeholder="enter your first name" required="required" name="departureDateInput" />
                  <label for="lastname" class="label-title">Period</label>
                  <input type="text" id="lastname" class="form-input" placeholder="by hours" name="periodInput"/>
            ...
            <div class="form-footer">
              <span>* required</span>
              <button type="submit" class="btn" value="Create" name="FormButton">Create</button>
            </div>
